...
class SimpleDQN(object):
	...
	def load_model(self, curriculum_no, beam_no, env_no):
		...
		experiment_file_name = '_c' + str(curriculum_no) + '_b' + str(beam_no) + '_e' + str(env_no)
		path_to_load = "/media/yash/SSHD/Robotics/curriculum_transfer/TurtleBot_interaction/turtlebot_ws/src/turtlebot_navigation/src/TurtleBot_crafting/" + os.sep + self.log_dir + os.sep + self.env_id + experiment_file_name + '.npz'
